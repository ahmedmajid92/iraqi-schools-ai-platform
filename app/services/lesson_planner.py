...
def build_lesson_plan(subject: str, grade: str, lesson_title: str, duration_minutes: int, lesson_type: str) -> Dict:
    ...
    objectives = [
        "أن تشرح الطالبة المفهوم/الفكرة بأسلوبها.",
        "أن تعطي مثالاً من واقعها يوضح الفكرة.",
        "أن تجيب عن أسئلة تقويم قصيرة بدقة."
    ]

    differentiation = [
        "طالبات بحاجة دعم: أسئلة مباشرة + أمثلة إضافية.",
        "طالبات متفوقات: سؤال توسّع أو تطبيق أعلى مستوى."
    ]

...
نظام ذكي متكامل لمساعدة المدرسين والطلاب في المدارس الإعدادية العراقية، مدعوم بالذكاء الاصطناعي ومعالجة اللغة العربية.
...
- **👥 أدوار المستخدمين**: مدرس/طالب مع صلاحيات مخصصة
...
│   ├── routes.py                 # جميع المسارات (API + صفحات): مدرس، طالب، مختبر، PDF
...
│   │   ├── signup.html           # صفحة إنشاء حساب جديد (مدرس/طالب)
